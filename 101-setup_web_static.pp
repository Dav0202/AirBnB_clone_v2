...
-> exec { '/usr/bin/env sed -i "/listen \[::\]:80 default_server/ a\\\trewrite ^/redirect_me http://HBehte6p.tech/hbnb_static permanent;" /etc/nginx/sites-available/default' : }
...
-> exec { '/usr/bin/env echo "New School!" > /data/web_static/releases/test/index.html' : }
